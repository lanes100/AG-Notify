# 🔔 AG Chat Notifications

> Instantly boost your AI-assisted coding productivity with crystal-clear, cross-platform sound alerts. 

**AG Chat Notifications** is a lightweight, 100% free VS Code extension designed to save your focus. It automatically plays beautifully synthesized sound notifications the very second you send a message or when your AI agent (like **Antigravity IDE**) finishes writing code and executing tasks. 
...
- **🎛️ Sleek Status Bar Controls:** Adds an elegant `$(bell) AG Chat Notifications` indicator to your status bar. Click it to open an interactive quick-pick control panel to:
...
1. **Install:** Search for **`AG Chat Notifications`** in the Antigravity IDE / VS Code Extensions marketplace and click **Install**.
...
*To change any sound chime, simply click `$(bell) AG Chat Notifications` in the bottom-right status bar or open the Settings Dashboard.*
